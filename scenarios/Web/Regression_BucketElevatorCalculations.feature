...
Background:
 ...
 Scenario: Verify zbucket elevator calculation for legacy minuteman metric flow
     ...
     Then  Verify all the elevator data shown in the reports with calculated and entered data '${ConveyorType}' '${CalculationName}' '${Site}' '${ConveyorName}' '${ConveyorType}' '${MaterialDensity}' '${TonsPerHourPeak}' '${MaterialLength}' '${MaterialProjection}' '${MaterialSpacing}' '${MaterialWeight}' '${MaterialVolume}' '${BucketRows}' '${MaterialWidth}' '${MaterialHeight}' '${MaterialSpeed}' '${DrivePulley}' '${TakeUpType}' '${MaximumTension}' '${MaximumPIW}' '${EffectiveTension}' '${BeltHorsepower}' '${PercentLoaded}' '${CounterweightTension}' '${CounterweightWeight}' '${WeightInEachBucket}' '${MimTailPulleyDiameter}' '${MaximumProjection}' '${AppropriateNumber}'


@Regression2 @CTCP-1079
@dataFile:resources/data/LegacyImperialBucketElevator.json
...
@dataFile:resources/data/CipherMetricBucketElevator.json
...
@dataFile:resources/data/CipherImperialBucketElevator.json
...
@dataFile:resources/data/MinutemanMetricBucketElevator.json
...
@dataFile:resources/data/MinutemanImperialBucketElevator.json
