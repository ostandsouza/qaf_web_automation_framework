...
Scenario: Verify the business demo flow
    ...
    And   Create a Distributor Corporate Belt Associates Corp '${companyname}' and '{Address}'
    And   Create a Distributor shop in India Belt Associates India with TM John Doe '{companyname1}' and '{Address1}'
