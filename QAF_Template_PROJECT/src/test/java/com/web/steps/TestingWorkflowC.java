...
public class TestingWorkflowC {
	...
	LoginPage loginpage = new LoginPage(); 
	 ...
	 public void loginWithAnd(String UserName, String Password) {
	  ...
	  @QAFTestStep(description="The user should be able to see Save as PDF button, but not Save as Draft")
	  public void theUserShouldBeAbleToSeeSaveAsPDFButtonButNotSaveAsDraft(){
