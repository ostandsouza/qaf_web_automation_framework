...
public class PDFHelper {
    ...
    public static PDDocument getPDFData(String filePath){
        PDDocument pdDocument = null;
        try {
            URL pdfUrl = Paths.get(filePath).toUri().toURL();
    ...
    public static String getPageContent(PDDocument document) throws IOException {
