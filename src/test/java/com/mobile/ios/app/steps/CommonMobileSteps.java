...
//			(app.getAppiumDriver() instanceof AndroidDriver ? (AndroidDriver)app.getAppiumDriver() : (IOSDriver)app.getAppiumDriver()).isAppInstalled(appName).removeApp(appName);
//
//		if (!(app.getAppiumDriver() instanceof AndroidDriver ? (AndroidDriver)app.getAppiumDriver() : (IOSDriver)app.getAppiumDriver()).isAppInstalled(appName).isAppInstalled(appName)) {
//			if (isUsingPerfecto) {
...
//			} else
//				(app.getAppiumDriver() instanceof AndroidDriver ? (AndroidDriver)app.getAppiumDriver() : (IOSDriver)app.getAppiumDriver()).isAppInstalled(appName).installApp(MiscUtils.getAbsolutePath(ConfigurationManager.getBundle().getString("aut.path")));
//		}
//
...
//		try {
//			(app.getAppiumDriver() instanceof AndroidDriver ? (AndroidDriver)app.getAppiumDriver() : (IOSDriver)app.getAppiumDriver()).isAppInstalled(appName).terminateApp(appName);
//			if (ConfigurationManager.getBundle().getBoolean("aut.clearCache"))
//				app.clearCache(appName);
//			(app.getAppiumDriver() instanceof AndroidDriver ? (AndroidDriver)app.getAppiumDriver() : (IOSDriver)app.getAppiumDriver()).isAppInstalled(appName).activateApp(appName);
//
