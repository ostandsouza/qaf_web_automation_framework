...
public class CustomMobileElement extends CustomElement {
    ...
    public void singleTap() {
        try {
            new TouchAction((AppiumDriver) this.getWrappedDriver().getUnderLayingDriver()).tap(new TapOptions().withElement(new ElementOption().withElement(this))).perform();
        } catch (Exception e) {
    ...
    public void doubleTap(String objName) {
        try {
            new TouchAction((AppiumDriver) this.getWrappedDriver().getUnderLayingDriver()).tap(new TapOptions().withElement(new ElementOption().withElement(this)).withTapsCount(2))
                    .perform();
    ...
    public void swipe(DIRECTION direction, String... objName) {
        ...
        new TouchAction((AppiumDriver) this.getWrappedDriver().getUnderLayingDriver()).press(PointOption.point(startX, startY)).waitAction(WaitOptions.waitOptions(Duration.ofMillis(200)))
