...
//        selectDistributorShop();
    ...
    {
        Validator.assertTrue(DashboardNativePage.getInstance().isCorporateList(),"User is not navigated to corporate list screen","User is  navigated to corporate list screen");
    }
